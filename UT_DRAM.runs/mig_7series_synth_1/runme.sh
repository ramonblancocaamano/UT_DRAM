...
HD_PWD='C:/Users/ramon/Documents/GITHUB/UT_DRAM/UT_DRAM.runs/mig_7series_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_7series.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_7series.tcl
